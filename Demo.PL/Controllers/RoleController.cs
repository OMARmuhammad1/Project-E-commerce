    ...
    public class RoleController : Controller
    {
        ...
        public async Task<IActionResult> Index(string Search)
        {
            if (string.IsNullOrEmpty(Search))
            {
                ...
                return View(MappedRole);//Return IEnumerable of RoleViewModel
            }
            else
            {
                var Role=await _roleManager.FindByNameAsync(Search);
                var MappedRole = _mapper.Map<IdentityRole, RoleViewModel>(Role);
               /* return View(MappedRole);*///Return  RoleViewModel Invalid Must Return IEnumerable of RoleViewModel
                return View(new List<RoleViewModel> { MappedRole});//Return IEnumerable of RoleViewModel
            }
